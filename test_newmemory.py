...
if __name__ == "__main__":
    ...
    graph_5_14 = torch.load("/mnt/hdd.data/hzc/clearscopes-e5/train_graphs/graph_5_14.TemporalData.simple")
    graph_5_15 = torch.load("/mnt/hdd.data/hzc/clearscopes-e5/train_graphs/graph_5_15.TemporalData.simple")
    ...
    memory, gnn, edge_pred, neighbor_loader, transformer = torch.load(f"/mnt/hdd.data/hzc/clearscopes-e5/artifact_cle5_3/models/new_models+10.pt",map_location=device)
